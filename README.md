...
Este proyecto es una API construida en FastAPI para administrar jugadores, partidos y estadísticas deportivas. Permite crear, listar, actualizar, así como relacionar jugadores con partidos mediante estadísticas.
